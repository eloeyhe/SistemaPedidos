...
|-----------------|-------------------------------|----------------|
| Eloy Eyheramendy| Diseñador de tarjetas CRC    | @eloeyhe      |
| Agustin Ariel Feijo| Modelador de diagramas de Casos de Uso     | @AgustinCalaver      |
| Leandro Dominguez | Especialista en escenarios de casos de uso | @Leandro2107     |
| Ignacio Velesquen        | Documentador y Coordinador    | @nachovelesquen7-rgb      |
...
- `README.md`: Descripción general del proyecto, datos del equipo y portal de navegación principal con enlaces a todos   los índices.
- `changelog.md`: Registro estructurado de contribuciones individuales, historial de cambios, Pull Requests e Issues vinculados.
- `ia/a2/`: Documentos Markdown por rol con el registro del uso de Copilot Agent Mode (prompts, archivos de contexto, outputs y ajustes técnicos).
- `diagramas/diagramasUML.md`: Índice general de navegación para toda la documentación gráfica y diagramas UML del sistema.
- `diagramas/02-casos-de-uso/`: Archivos PlantUML (`.puml`) e imágenes exportadas (`.png`) de los diagramas de casos de uso, junto a su índice `diagramas_de_casos_de_uso.md`.
- `diagramas/03-escenarios-casos-de-uso/`: Escenarios detallados de casos de uso en archivos Markdown individuales e índice general `escenarios_de_casos_de_uso.md`.
- `herramientas-agile/tarjetas-crc/`: Tarjetas CRC en Markdown por cada clase clave del sistema e índice general `herramientas_agile.md`.
