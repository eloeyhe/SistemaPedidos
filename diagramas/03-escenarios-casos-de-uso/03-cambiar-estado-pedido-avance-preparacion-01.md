...
| **Requerimientos:**                        | RF3, RF5, RNF2, RNF4, RNF5                                                                                                                                                              |
| **Aspectos sobresalientes:**              | Solo se permiten las transiciones `RECIBIDO` -> `EN_PREPARACION` -> `LISTO` -> `ENTREGADO` y la cancelación autorizada. Cocina controla los cambios de preparación y Mostrador registra la entrega. Una transición inválida o sin autorización no modifica el estado. |
| **Prioridad:**                            | Alta                                                                                                                                                                                      |
| **Riesgo:**                               | Medio                                                                                                                                                                                     |
