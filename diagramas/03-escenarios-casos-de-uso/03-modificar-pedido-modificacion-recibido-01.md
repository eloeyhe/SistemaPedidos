...
| **Reunir requerimentos:**                 | RF3, RF4, RF8                                                                                                                                                                                 |
| **Aspectos sobresalientes:**              | ¿Qué ocurre si el pedido cambia a `EN_PREPARACION` mientras se realiza la modificación? ¿Cómo se informa que una modificación ya no está permitida? ¿Cómo se registra una diferencia de pago? |
| **Prioridad:**                            | Alta                                                                                                                                                                                          |
| **Riesgo:**                               | Medio                                                                                                                                                                                         |
