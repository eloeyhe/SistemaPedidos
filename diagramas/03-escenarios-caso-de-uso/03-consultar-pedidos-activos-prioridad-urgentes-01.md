...
| **Reunir requerimentos:**                 | RF3, RF7, RNF4                                                                                                                                                             |
| **Aspectos sobresalientes:**              | ¿Cómo se actualiza la información cuando cambia el estado de un pedido? ¿Qué sucede si no existen pedidos activos? ¿Cómo se informa una falla de conexión o actualización? |
| **Prioridad:**                            | Alta                                                                                                                                                                       |
| **Riesgo:**                               | Medio                                                                                                                                                                      |
